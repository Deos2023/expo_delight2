...
import tourData from '../../lib/tour-data'; // Adjust the path if needed
  ...
  return (
    <div className="relative w-full min-h-screen sm:pt-0 pt-20 text-white">
      ...
      <div className="relative z-10 px-6 py-16 max-w-7xl mx-auto">
        <h1 className="text-4xl md:text-5xl font-bold text-center mb-12">Jungle Safari Tours</h1>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {jungleSafaris.map((tour) => (
            <div
              key={tour.slug}
            ...
            >
              ...
              <p className="mt-3 font-medium text-green-400">₹{tour.price.toLocaleString()}</p>
            </div>
          ))}
        </div>
      </div>
